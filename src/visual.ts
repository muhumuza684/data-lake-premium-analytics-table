...
export class DataLakeTables implements IVisual {
    ...
    private parseColumns(columns: DataViewMetadataColumn[]): {
        ...
        columns.forEach((col, index) => {
            ...
            const isGroup = isRole("groupBy", "group", "columns");
            const isRow = isRole("rows", "row", "category");
            const isValue = isRole("values", "value", "ameasure", "pymeasure", "plmeasure", "fcmeasure", "signMeasure", "others");
