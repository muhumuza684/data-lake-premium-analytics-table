...
/** INFORIVAPREM palettes. Every preset is wired to live conditional-format colors. */
...
export class TableRenderer {
    ...
    private reportTitle = "INFORIVAPREM";
    ...
    private renderDataLakeLayoutSection(menu: HTMLDivElement): void {
        ...
        title.textContent = "INFORIVAPREM layout";
    ...
    private renderToolbar(): void {
        ...
        const optionsLabel = this.loc("Toolbar_TableOptions", "INFORIVAPREM settings");
        ...
        hamburger.setAttribute("aria-label", "INFORIVAPREM settings");
        hamburger.title = "INFORIVAPREM settings";
    ...
    public renderEmptyState(): void {
        ...
        brand.textContent = this.loc("EmptyState_Brand", "INFORIVAPREM");
     ...
     * an added plain-language description of what INFORIVAPREM does.
     */
    public renderLandingPage(): void {
        ...
        const brand = document.createElement("div");
        brand.className = "skiba-empty-state__brand";
        brand.textContent = this.loc("Landing_Brand", "INFORIVAPREM");
        wrap.appendChild(brand);
